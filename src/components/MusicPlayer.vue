  ...
  >
    <div class="flex items-center w-1/2 sm:w-1/4">
      <div class="flex items-center ml-4">
        ...
        />
        <div class="ml-4">
          <p class="text-[14px] text-white hover:underline cursor-pointer">
            {{ currentTrack.name }}
          </p>
          <p class="text-[11px] text-gray-500 hover:underline hover:text-white cursor-pointer">
            {{ currentArtist.name }}
          </p>
        </div>
      </div>
    ...
    <div class="max-w-[35%] mx-auto sm:w-2/4 mb-3">
    ...
    <div class="sm:flex items-center sm:w-1/4 justify-end pr-10 hidden">
      <MusicPlayerVolume />
    </div>
  </div>
</template>
