...
<template>
  <div>
    <div
      id="TopNav"
      class="w-3/4 sm:w-[calc(100%-240px)] h-[60px] fixed right-0 z-20 bg-[#101010] bg-opacity-80 flex items-center justify-between"
    >
      ...
      >
        <div class="flex items-center">
          ...
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold hidden sm:block">Carlos Gomes</div>
    ...
    <aside id="SideNav" class="h-[100%] p-6 w-1/4 sm:w-[240px] fixed z-50 bg-black">
      <RouterLink to="/">
  ...
  <div
    class="fixed right-0 top-0 w-3/4 sm:w-[calc(100%-240px)] overflow-auto h-full bg-gradient-to-b from-[#1C1C1C] to-black"
  >
