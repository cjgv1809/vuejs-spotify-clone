...
<template>
  <div class="p-8 overflow-x-hidden">
    ...
    <div class="flex items-center w-full relative h-full">
      <img width="140" :src="artist.albumCover" alt="album cover" class="rounded-md" />

      <div class="w-full ml-5 hidden sm:block">
        <p
          style="font-size: 33px"
          class="text-white absolute w-full hover:underline cursor-pointer top-0 text-base font-semibold"
        >
          {{ artist.name }}
        </p>
    ...
    <div class="flex items-center justify-between px-5 pt-2">
      <div class="flex items-center justify-between text-gray-400">
        <div class="mr-7 hidden sm:block">#</div>
